...
//===== industrial
gtloader.load('assets/models/skysc/PUSHILIN_skyscraper.gltf',
	(gltfmodel)=>{
   ...
   skyscraper.children[2].visible=false
	...
	gtloader.load('assets/models/skysc2/model.gltf',
	(gltfmodel)=>{
   ...
   factory.children[2].visible=false
	...
	gtloader.load('assets/models/skyscs/Skycraper_173.gltf',
	(gltfmodel)=>{
   ...
   //factory.children[2].visible=false
	...
	gtloader.load('assets/models/factory/CUPIC_FACTORy.gltf',
	(gltfmodel)=>{
	const factory= gltfmodel.scene
   ...
   factory.children[2].visible=false
	...
	gtloader.load('assets/models/hstl/CUPIC_HOSTEL.gltf',
	(gltfmodel)=>{
	const hostel= gltfmodel.scene
    hostel.scale.set(0.01,0.04,0.01)
   //factory.children[2].visible=false
	hostel.position.set(5,0,72)
	scene.add(hostel)
	},undefined,console.log)
    gtloader.load('assets/models/canyon/model.gltf',
	(gltfmodel)=>{
